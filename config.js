...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/2cecad9c5b0e1e34e8299.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'DARK-X-KING;Raja;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'DARK-X-KING',
    AUDIO_DATA: process.env.AUDIO_DATA === raja || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭BISWAJITꫂ;DARK-X bot;https://telegra.ph/file/2cecad9c5b0e1e34e8299.jpg' : process.env.AUDIO_DATA,
